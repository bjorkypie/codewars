...
this one is a doozy that I will need to come back to...
*/

function nbaCup(resultSheet, toFind) {
  //separate games results
  let resultArr = resultSheet.split(',')
  //separate team names from score with regex
  let score
  let team1 = '';
  let team2 = '';
  //regex for numbers
  let regex = /[0-9]/
  //declare empty array to store game objects
  let gameObjArr = [];

  //search for games won
  //search for ties
  //sum total points
  //sum total lost points
  //calculate marks
}
